...
ca = added_conv_model.CA(channel_n=CHANNEL_NUM,model_name=date_time+'_'+os.path.basename(__file__).split('.')[0]+"_batch_"+str(STATES)+"_states_single_C",rule_model="batch")
