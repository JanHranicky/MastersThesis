...
class discreteOutTrainer(trainer.Trainer):
    def __init__(self,model,loss_f,gt_img,gt_img_name,grayscale=False,data_pool_training=False,lr=0.001,epoch_num=300001,visualize=True,visualize_iters=10000,save_iters=5000,generate_gif_iters=5000,train_step_interval=(25,50)):
...
ca = added_conv_model.CA(channel_n=16,model_name=date_time+"_batch_norm_multiplic",rule_model=layers)
